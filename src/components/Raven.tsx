...
const Raven = () => {
  ...
  return (
    <Card 
      className={`fixed right-4 bg-transparent backdrop-blur-sm border-[#8E9196]/10 shadow-2xl transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 ${
